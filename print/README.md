...
Known issue: two of the Pi 5's mounting holes are covered above. The barb has nowhere to click open there and the peg breaks if forced. Use the snap pegs only on the two open holes; a rework to expansion pins that grip inside the bore is planned.
