...
- First shopping trip missed a few things: the soldering iron, the SD cards for the Pi Zeros, and the M-M and M-F jumpers. Went back the next day. Check the list twice.
...
Lesson: a Pi that fails to boot might just be a bad outlet.
