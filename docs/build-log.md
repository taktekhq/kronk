...
- Amp taps the gate unit's 5V rail upstream of the Pi, not the Pi's 5V pin, where the relay already sits. That rail is the USB charger today and the buck once the unit runs off 12V. 12V straight to the amp would drive the 3W speaker past its rating.
